...
const TITLE = 'Brand Launch Kit';
const DESCRIPTION = 'Turn brand colors, logo variations, and usage decisions into a portable implementation kit with design tokens, guidelines, a website prompt, and an AI coding skill.';
const GITHUB_REPO = '';
